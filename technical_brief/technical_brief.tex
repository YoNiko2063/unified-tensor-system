...
\author{Nikolas Yoo\\
        \small Unified Tensor Systems \quad|\quad
...
All generators operate at $P_e = 2P_m$ ($\delta_s = 30^\circ$).
...
\begin{itemize}[nosep]
  ...
  \item Uniform loading: $P_e = 2P_m \Rightarrow \delta_s = 30^\circ$ for all generators
\end{itemize}
...
($\delta_s = 30^\circ$) and stable across all generator subsets (CV = 0.66\%).
